...
public class OrgStructureRouterTest extends BaseRouterTest {
    ...
    public void testFilterStructures() {
        ...
        var response = client.post("/v1/management/org_structures/filter").submit(input, JsonObject.class);
    ...
    public void testCreateStructures() {
        ...
        var response = client.post("/v1/management/org_structures").submit(input, JsonObject.class);
    ...
    public void testUpdateStructures() {
        ...
        var response = client.put("/v1/management/org_structures").submit(input, JsonObject.class);
    ...
    public void testDeleteStructures() {
        ...
        var response = client.delete("/v1/management/org_structures/" + "6934836b").submit(input, JsonObject.class);

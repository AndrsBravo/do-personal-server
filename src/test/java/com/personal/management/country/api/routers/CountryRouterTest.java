...
public class CountryRouterTest extends BaseRouterTest {
    ...
    public void testFilterCountries() {
        ...
        var response = client.post("/v1/management/countries/filter").submit(input, JsonObject.class);
    ...
    public void testCreateCountries() {
        ...
        var response = client.post("/v1/management/countries").submit(input, JsonObject.class);
    ...
    public void testUpdateCountries() {
        ...
        var response = client.put("/v1/management/countries").submit(input, JsonObject.class);
    ...
    public void testDeleteCountries() {
        ...
        var response = client.delete("/v1/management/countries/" + "dc60f986").submit(input, JsonObject.class);

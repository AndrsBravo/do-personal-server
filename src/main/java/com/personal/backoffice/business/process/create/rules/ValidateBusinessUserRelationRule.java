...
public class ValidateBusinessUserRelationRule implements IProcessRule<CreateBusinessProcess> {

    @Override
    public void apply(CreateBusinessProcess process) {

        var pLogger = LogFactory.builder(CreateBusinessProcess.class, ValidateBusinessUserRelationRule.class);

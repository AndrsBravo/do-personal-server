...
public class DeleteClientTypeService implements IDeleteService {
    ...
    public ServiceResult delete(Query query) {
        ...
        try {
            ...
            builder.withRecords(records)
                    .withNotification(ClientTypeNotificationFactory.DeleteClientTypeSuccess())
                    .get();
        } catch (Exception e) {
            builder.withException(e)
                    .withNotification(ClientTypeNotificationFactory.DeleteClientTypeFail())
                    .get();
        }
        return builder.get();
    }

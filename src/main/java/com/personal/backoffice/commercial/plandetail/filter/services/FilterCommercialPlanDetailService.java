...
public class FilterCommercialPlanDetailService extends FilterService<CommercialPlanDetail> {
    ...
    @Override
    public FetchResult<CommercialPlanDetail> filter(Query query) {
        ...
        try {
            ...
            builder.withResult(result)
                    .withNotification(CommercialPlanDetailNotificationFactory.FetchCommercialPlanDetailSuccess());
        } catch (Exception e) {
            builder.withException(e).
                    withNotification(CommercialPlanDetailNotificationFactory.FetchCommercialPlanDetailFail());
        }

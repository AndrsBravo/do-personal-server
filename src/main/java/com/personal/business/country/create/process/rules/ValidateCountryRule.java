package com.personal.business.country.create.process.rules;

import com.personal.business.country.create.process.CreateCountryProcess;
...
public class ValidateCountryRule implements IProcessRule<CreateCountryProcess> {
    ...
    public void apply(CreateCountryProcess process) {
        ...
        process.addLog(pLogger.INFO("Crear nuevo País en Management", "País creado con éxito"));

package com.personal.business.benefitrate.create.routes;

import com.personal.business.benefitrate.create.inputs.BenefitRateInput;
import com.personal.business.benefitrate.create.process.CreateBenefitRateProcessExecutor;

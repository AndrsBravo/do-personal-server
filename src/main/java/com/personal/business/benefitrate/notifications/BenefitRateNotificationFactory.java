...
public class BenefitRateNotificationFactory {
    ...
    public static Notification FetchBenefitRateSuccess() {
        return new Notification("Lista valores de los beneficios");
    }

    public static Notification FetchBenefitRateFail() {
        return new Notification("Ha ocurrido un error mientras se consultaban los valores de los beneficios.");
    }

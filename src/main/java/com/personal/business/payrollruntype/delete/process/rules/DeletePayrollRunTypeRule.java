package com.personal.business.payrollruntype.delete.process.rules;

import com.personal.business.payrollruntype.delete.process.DeletePayrollRunTypeProcess;
...
public class DeletePayrollRunTypeRule implements IProcessRule<DeletePayrollRunTypeProcess> {
    ...
    public void apply(DeletePayrollRunTypeProcess process) {
        ...
        var createPayrollRunType = PayrollRunTypeServiceFactory.DeletePayrollRunType(payrollRunType.getBusiness().getDbName());

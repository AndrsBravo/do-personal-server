package com.personal.business.payrollruntype.filter.routes;

import com.personal.business.payrollruntype.filter.process.FilterPayrollRunTypeProcessExecutor;
...
public class FilterPayrollRunTypeHttpHandler {
    ...
    public void Post(ServerRequest request, ServerResponse response) {
        var payrollRunTypesFilterInput = request.content().as(BusinessFilterTypeInput.class);

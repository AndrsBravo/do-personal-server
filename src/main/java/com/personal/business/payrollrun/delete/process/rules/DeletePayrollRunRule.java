package com.personal.business.payrollrun.delete.process.rules;

import com.personal.business.payrollrun.delete.process.DeletePayrollRunProcess;
...
public class DeletePayrollRunRule implements IProcessRule<DeletePayrollRunProcess> {
    ...
    public void apply(DeletePayrollRunProcess process) {
        ...
        var createPayrollRun = PayrollRunServiceFactory.DeletePayrollRun(payrollRun.getBusiness().getDbName());

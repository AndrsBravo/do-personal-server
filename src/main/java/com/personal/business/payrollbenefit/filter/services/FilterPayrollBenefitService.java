package com.personal.business.payrollbenefit.filter.services;
...
public class FilterPayrollBenefitService implements IFilterService<PayrollBenefit> {
    ...
    public ServiceResult<List<PayrollBenefit>> filter(Query query) {
        ...
        var queryString = query.Select("payroll_benefits",
                "id", "business_id", "business_benefits_id", "payrolls_id", "updated_at", "created_at", "created_by")
                .Get();
        ...
        var result = this.dbClient.get().execute()
                ...
                .With(PayrollBenefit::setBusiness, new Business(dbRow.column("business_id").getString()))

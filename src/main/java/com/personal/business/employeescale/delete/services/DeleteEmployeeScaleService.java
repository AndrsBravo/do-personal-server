...
public class DeleteEmployeeScaleService implements IDeleteService {
    ...
    public ServiceResult delete(Query query) {
        ...
        try {
            ...
            builder.withRecords(records)
                    .withNotification(EmployeeScaleNotificationFactory.DeleteEmployeeScaleSuccess())
                    .get();
        } catch (Exception e) {
            builder.withException(e)
                    .withNotification(EmployeeScaleNotificationFactory.DeleteEmployeeScaleFail())
                    .get();
        }
        return builder.get();
    }

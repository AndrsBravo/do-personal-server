...
public class FilterEmployeeScaleService extends FilterService<EmployeeScale> {
    ...
    @Override
    public FetchResult<EmployeeScale> filter(Query query) {
        ...
        try {
            ...
            builder.withResult(result)
                    .withNotification(EmployeeScaleNotificationFactory.FetchEmployeeScaleSuccess());
        } catch (Exception e) {
            builder.withException(e).
                    withNotification(EmployeeScaleNotificationFactory.FetchEmployeeScaleFail());
        }

package com.personal.business.financecategory.filter.routes;

import com.personal.business.financecategory.filter.inputs.FilterFinanceCategoryInput;
import com.personal.business.financecategory.filter.process.FilterFinanceCategoryProcessExecutor;

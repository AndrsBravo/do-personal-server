package com.personal.business.financecategory.delete.process.rules;

import com.personal.business.financecategory.delete.process.DeleteFinanceCategoryProcess;
...
public class DeleteFinanceCategoryRule implements IProcessRule<DeleteFinanceCategoryProcess> {
    ...
    public void apply(DeleteFinanceCategoryProcess process) {
        ...
        var createFinanceCategory = FinanceCategoryServiceFactory.DeleteFinanceCategory(financeCategory.getBusiness().getDbName());

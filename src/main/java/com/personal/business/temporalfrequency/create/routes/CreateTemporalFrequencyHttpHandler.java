package com.personal.business.temporalfrequency.create.routes;

import com.personal.business.temporalfrequency.create.inputs.TemporalFrequencyInput;
import com.personal.business.temporalfrequency.create.process.CreateTemporalFrequencyProcessExecutor;

package com.personal.business.temporalfrequency.delete.process.rules;

import com.personal.business.temporalfrequency.delete.process.DeleteTemporalFrequencyProcess;
...
public class DeleteTemporalFrequencyRule implements IProcessRule<DeleteTemporalFrequencyProcess> {
    ...
    public void apply(DeleteTemporalFrequencyProcess process) {
        ...
        var createTemporalFrequency = TemporalFrequencyServiceFactory.DeleteTemporalFrequency(temporalFrequency.getBusiness().getDbName());

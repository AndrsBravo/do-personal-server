package com.personal.business.payrolldeduction.delete.process.rules;

import com.personal.business.payrolldeduction.delete.process.DeletePayrollDeductionProcess;
...
public class DeletePayrollDeductionRule implements IProcessRule<DeletePayrollDeductionProcess> {
    ...
    public void apply(DeletePayrollDeductionProcess process) {
        ...
        var createPayrollDeduction = PayrollDeductionServiceFactory.DeletePayrollDeduction(payrollDeduction.getBusiness().getDbName());

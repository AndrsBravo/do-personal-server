package com.personal.business.payrolldeduction.update.process.rules;

import com.personal.business.payrolldeduction.factories.PayrollDeductionServiceFactory;
import com.personal.business.payrolldeduction.update.process.UpdatePayrollDeductionProcess;
...
public class UpdatePayrollDeductionRule implements IProcessRule<UpdatePayrollDeductionProcess> {
    ...
    public void apply(UpdatePayrollDeductionProcess process) {
        ...
        var createPayrollDeduction = PayrollDeductionServiceFactory.EditPayrollDeduction(payrollDeduction.getBusiness().getDbName());

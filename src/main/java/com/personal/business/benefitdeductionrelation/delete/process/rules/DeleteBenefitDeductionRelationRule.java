package com.personal.business.benefitdeductionrelation.delete.process.rules;

import com.personal.business.benefitdeductionrelation.delete.process.DeleteBenefitDeductionRelationProcess;
...
public class DeleteBenefitDeductionRelationRule implements IProcessRule<DeleteBenefitDeductionRelationProcess> {
    ...
    public void apply(DeleteBenefitDeductionRelationProcess process) {
        ...
        var createBenefitDeductionRelation = BenefitDeductionRelationServiceFactory.DeleteBenefitDeductionRelation(benefitDeductionRelation.getBusiness().getDbName());

package com.personal.business.payrollrundeduction.filter.process.rules;

import com.personal.business.payrollrundeduction.factories.PayrollRunDeductionServiceFactory;
import com.personal.business.payrollrundeduction.filter.process.FilterPayrollRunDeductionProcess;
...
public class FilterPayrollRunDeductionRule implements IProcessRule<FilterPayrollRunDeductionProcess> {
    ...
    public void apply(FilterPayrollRunDeductionProcess process) {
        ...
        var filterPayrollRunDeduction = PayrollRunDeductionServiceFactory.FilterPayrollRunDeduction(payrollRunDeductionFilter.getBusiness().getDbName());

package com.personal.business.payrollrundeduction.delete.process.rules;

import com.personal.business.payrollrundeduction.delete.process.DeletePayrollRunDeductionProcess;
...
public class DeletePayrollRunDeductionRule implements IProcessRule<DeletePayrollRunDeductionProcess> {
    ...
    public void apply(DeletePayrollRunDeductionProcess process) {
        ...
        var createPayrollRunDeduction = PayrollRunDeductionServiceFactory.DeletePayrollRunDeduction(payrollRunDeduction.getBusiness().getDbName());

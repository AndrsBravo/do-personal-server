package com.personal.business.payrollcalculationresult.entities;

import com.personal.business.payroll.entities.Payroll;
import com.personal.shared.entities.BusinessEntity;

public class PayrollCalculationResult extends BusinessEntity {
    ...
    public PayrollCalculationResult(String id) {
        super(id);
    }

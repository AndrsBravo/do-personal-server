package com.personal.business.origincategory.create.routes;

import com.personal.business.origincategory.create.inputs.OriginCategoryInput;
import com.personal.business.origincategory.create.process.CreateOriginCategoryProcessExecutor;

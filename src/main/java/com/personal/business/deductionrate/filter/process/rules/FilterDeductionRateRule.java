package com.personal.business.deductionrate.filter.process.rules;

import com.personal.business.deductionrate.factories.DeductionRateServiceFactory;
import com.personal.business.deductionrate.filter.process.FilterDeductionRateProcess;
...
public class FilterDeductionRateRule implements IProcessRule<FilterDeductionRateProcess> {
    ...
    public void apply(FilterDeductionRateProcess process) {
        ...
        if (deductionRateFilter.getAll() != null) {
            query.Field("id", "");
        ...
        var filterDeductionRate = DeductionRateServiceFactory.FilterDeductionRate(deductionRateFilter.getBusiness().getDbName());

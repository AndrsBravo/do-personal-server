package com.personal.business.orgstructure.create.routes;

import com.personal.business.orgstructure.create.inputs.OrgStructureInput;
import com.personal.business.orgstructure.create.process.CreateOrgStructureProcessExecutor;

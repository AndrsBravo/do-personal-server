...
public class UpdateBuilder {
    ...
    public UpdateBuilder(String tableName, Map<String, String> fields) {
        this.fields = fields;
        this.keyPair = new StringBuilder();
        this.updateQuery = new StringBuilder();
        this.tableName = "UPDATE " + tableName + " SET ";
    }

    public UpdateBuilder Set(String key) {

        if (!this.fields.containsKey(key)) {
            return this;
        }
        if (!this.updateQuery.isEmpty()) {
            this.updateQuery.append(", ");
        }

        this.updateQuery.append(key).append(" = :").append(key);
        return this;
    }

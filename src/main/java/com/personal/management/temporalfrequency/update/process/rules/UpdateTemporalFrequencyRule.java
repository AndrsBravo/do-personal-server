package com.personal.management.temporalfrequency.update.process.rules;

import com.personal.management.temporalfrequency.factories.TemporalFrequencyServiceFactory;
import com.personal.management.temporalfrequency.update.process.UpdateTemporalFrequencyProcess;
...
public class UpdateTemporalFrequencyRule implements IProcessRule<UpdateTemporalFrequencyProcess> {
    ...
    public void apply(UpdateTemporalFrequencyProcess process) {
        ...
        var createTemporalFrequency = TemporalFrequencyServiceFactory.EditTemporalFrequency();

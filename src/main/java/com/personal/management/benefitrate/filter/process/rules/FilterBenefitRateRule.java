package com.personal.management.benefitrate.filter.process.rules;

import com.personal.management.benefitrate.factories.BenefitRateServiceFactory;
import com.personal.management.benefitrate.filter.process.FilterBenefitRateProcess;
...
public class FilterBenefitRateRule implements IProcessRule<FilterBenefitRateProcess> {
    ...
    public void apply(FilterBenefitRateProcess process) {
        ...
        var filterBenefitRate = BenefitRateServiceFactory.FilterBenefitRate();

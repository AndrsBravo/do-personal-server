package com.personal.management.benefit.create.process.rules;

import com.personal.management.benefit.create.process.CreateBenefitProcess;
...
public class CreateBenefitRule implements IProcessRule<CreateBenefitProcess> {
    ...
    public void apply(CreateBenefitProcess process) {
        ...
        var createBenefit = BenefitServiceFactory.CreateBenefit();

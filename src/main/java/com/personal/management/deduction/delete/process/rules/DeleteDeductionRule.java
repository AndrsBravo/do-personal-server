package com.personal.management.deduction.delete.process.rules;

import com.personal.management.deduction.delete.process.DeleteDeductionProcess;
...
public class DeleteDeductionRule implements IProcessRule<DeleteDeductionProcess> {
    ...
    public void apply(DeleteDeductionProcess process) {
        ...
        var createDeduction = DeductionServiceFactory.DeleteDeduction();

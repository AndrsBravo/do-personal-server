package com.personal.management.deduction.create.process.rules;

import com.personal.management.deduction.create.process.CreateDeductionProcess;
...
public class CreateDeductionRule implements IProcessRule<CreateDeductionProcess> {
    ...
    public void apply(CreateDeductionProcess process) {
        ...
        var createDeduction = DeductionServiceFactory.CreateDeduction();

package com.personal.management.financecategory.create.routes;

import com.personal.management.financecategory.create.inputs.FinanceCategoryInput;
import com.personal.management.financecategory.create.process.CreateFinanceCategoryProcessExecutor;

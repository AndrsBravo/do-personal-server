package com.personal.management.benefitcategory.create.routes;

import com.personal.management.benefitcategory.create.inputs.BenefitCategoryInput;
import com.personal.management.benefitcategory.create.process.CreateBenefitCategoryProcessExecutor;

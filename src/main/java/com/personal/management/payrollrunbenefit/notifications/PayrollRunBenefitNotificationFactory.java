package com.personal.management.payrollrunbenefit.notifications;
...
public class PayrollRunBenefitNotificationFactory {
    ...
    public static Notification UpdatePayrollRunBenefitSuccess() {
        return new Notification("El beneficio para calculo de nomina se ha actualizado correctamente.");
    }

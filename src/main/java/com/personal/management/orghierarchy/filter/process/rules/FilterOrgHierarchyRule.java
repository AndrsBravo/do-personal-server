package com.personal.management.orghierarchy.filter.process.rules;

import com.personal.management.orghierarchy.factories.OrgHierarchyServiceFactory;
import com.personal.management.orghierarchy.filter.process.FilterOrgHierarchyProcess;
...
public class FilterOrgHierarchyRule implements IProcessRule<FilterOrgHierarchyProcess> {
    ...
    public void apply(FilterOrgHierarchyProcess process) {
        ...
        var filterOrgHierarchy = OrgHierarchyServiceFactory.FilterOrgHierarchy();

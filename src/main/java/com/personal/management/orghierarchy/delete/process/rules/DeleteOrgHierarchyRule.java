package com.personal.management.orghierarchy.delete.process.rules;

import com.personal.management.orghierarchy.delete.process.DeleteOrgHierarchyProcess;
...
public class DeleteOrgHierarchyRule implements IProcessRule<DeleteOrgHierarchyProcess> {
    ...
    public void apply(DeleteOrgHierarchyProcess process) {
        ...
        var createOrgHierarchy = OrgHierarchyServiceFactory.DeleteOrgHierarchy();

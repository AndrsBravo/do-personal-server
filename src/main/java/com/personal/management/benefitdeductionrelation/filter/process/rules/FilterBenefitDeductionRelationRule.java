package com.personal.management.benefitdeductionrelation.filter.process.rules;

import com.personal.management.benefitdeductionrelation.factories.BenefitDeductionRelationServiceFactory;
import com.personal.management.benefitdeductionrelation.filter.process.FilterBenefitDeductionRelationProcess;
...
public class FilterBenefitDeductionRelationRule implements IProcessRule<FilterBenefitDeductionRelationProcess> {
    ...
    public void apply(FilterBenefitDeductionRelationProcess process) {
        ...
        var filterBenefitDeductionRelation = BenefitDeductionRelationServiceFactory.FilterBenefitDeductionRelation();

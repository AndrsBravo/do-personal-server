package com.personal.management.origincategory.update.routes;

import com.personal.management.origincategory.create.inputs.OriginCategoryInput;
import com.personal.management.origincategory.update.process.UpdateOriginCategoryProcessExecutor;

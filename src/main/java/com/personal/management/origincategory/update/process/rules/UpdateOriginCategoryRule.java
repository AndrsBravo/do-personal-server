package com.personal.management.origincategory.update.process.rules;

import com.personal.management.origincategory.factories.OriginCategoryServiceFactory;
import com.personal.management.origincategory.update.process.UpdateOriginCategoryProcess;
...
public class UpdateOriginCategoryRule implements IProcessRule<UpdateOriginCategoryProcess> {
    ...
    public void apply(UpdateOriginCategoryProcess process) {
        ...
        var createOriginCategory = OriginCategoryServiceFactory.EditOriginCategory();

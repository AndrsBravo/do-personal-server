package com.personal.management.payroll.update.process.rules;

import com.personal.management.payroll.factories.PayrollServiceFactory;
import com.personal.management.payroll.update.process.UpdatePayrollProcess;
...
public class UpdatePayrollRule implements IProcessRule<UpdatePayrollProcess> {
    ...
    public void apply(UpdatePayrollProcess process) {
        ...
        var createPayroll = PayrollServiceFactory.EditPayroll();

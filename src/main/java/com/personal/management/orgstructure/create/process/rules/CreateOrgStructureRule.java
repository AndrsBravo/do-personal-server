package com.personal.management.orgstructure.create.process.rules;

import com.personal.management.orgstructure.create.process.CreateOrgStructureProcess;
...
public class CreateOrgStructureRule implements IProcessRule<CreateOrgStructureProcess> {
    ...
    public void apply(CreateOrgStructureProcess process) {
        ...
        var createOrgStructure = OrgStructureServiceFactory.CreateOrgStructure();

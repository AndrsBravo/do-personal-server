package com.personal.management.orgstructure.filter.routes;

import com.personal.management.orgstructure.filter.inputs.FilterOrgStructureInput;
import com.personal.management.orgstructure.filter.process.FilterOrgStructureProcessExecutor;

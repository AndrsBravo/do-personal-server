package com.personal.management.orgstructure.delete.process.rules;

import com.personal.management.orgstructure.delete.process.DeleteOrgStructureProcess;
...
public class DeleteOrgStructureRule implements IProcessRule<DeleteOrgStructureProcess> {
    ...
    public void apply(DeleteOrgStructureProcess process) {
        ...
        var createOrgStructure = OrgStructureServiceFactory.DeleteOrgStructure();

package com.personal.management.payrollrun.filter.process.rules;

import com.personal.management.payrollrun.factories.PayrollRunServiceFactory;
import com.personal.management.payrollrun.filter.process.FilterPayrollRunProcess;
...
public class FilterPayrollRunRule implements IProcessRule<FilterPayrollRunProcess> {
    ...
    public void apply(FilterPayrollRunProcess process) {
        ...
        var filterPayrollRun = PayrollRunServiceFactory.FilterPayrollRun();
